    ...
    <>
        ...
        <div className='about_container'>
            <div className='details_container'>
                <p className='about_heading'>About the competition</p>
            ...
            <div className='details_container jury'>
                ...
                <p className='about_heading'>The Jury Panel</p>
                <p className='about_content'> The winners from the shortlisted entries will be selected by our distinguished jury panel Rajat Kathuria, Shivani Mutneja, Trisha De Niyogi</p>
                </div>
                <div className='jury_main_container'>
                    <div className='jury_container'>
                        <img src={rajat} className='jury_img' alt='Rajat Kathuria photo'></img>
                        <p>
                    ...
                    <div className='jury_container'>
                        <img src={shivani} className='jury_img' alt='Shivani mutneja photo'></img>
                        <p>
                    ...
                    <div className='jury_container'>
                        <img src={trisha } className='jury_img' alt='Trisha De Niyogi photo'></img>
                        <p>
            ...
            <div className='details_container'>
                ...
                <p className='about_content'>
                    ...
                    To find out more about admissions at SNU, click <a target='_blank' href='https://snuadmissions.com/'>here </a>.
                </p>

            </div>
            <div className='details_container'>
                <p className='about_heading'>The Freewheeler</p>
                <p className='about_content'> 
                    Now in its 10th year of publication, The Freewheeler is the student-run annual literary magazine of the Department of English. Not only does it provide an exciting opportunity for students to explore various forms of creative writing, it also serves as a platform for budding editors and designers to hone their skills. Submissions undergo rigorous review and every issue is crafted with a great deal of emphasis on quality and originality. Back issues of The Freewheeler can be found <a href='https://snu.edu.in/news/freewheeler' target='_blank'>here.</a> 
                </p>
            </div>
            <div className='details_container'>
                <p className='about_heading'>About the Logo</p>
                <p className='about_content'>
